...
public class VisionSubsystem extends SubsystemBase {
  ...
  private double lastTimeApriltagDetected = 0.0;
  ...
  public void periodic() {
    ...
    if (robotPose.isPresent()) {
      ...
      lastTimeApriltagDetected = RobotController.getFPGATime() / 1000000.0;
    };
  }
  ...
  public boolean lookingAtAprilTag() {
    ...
    return currentTime - lastTimeApriltagDetected <= 0.5;
  }
}
